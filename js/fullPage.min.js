! function(e, t, n, o, r) { "function" == typeof define && define.amd ? define(function() { return e.fullpage = o(t, n), e.fullpage }) : "object" == typeof exports ? module.exports = o(t, n) : t.fullpage = o(t, n) }(this, window, document, function(Lt, xt) {
    "use strict";
    var At = "fullpage-wrapper",
        Tt = "." + At,
        kt = "fp-responsive",
        Mt = "fp-notransition",
        Ot = "fp-destroyed",
    ...
    function cn(e) {
        ...
        for (var t = 1, n = arguments.length; t < n; ++t) {
            var o = arguments[t];
            if (o)
                for (var r in o) o.hasOwnProperty(r) && ("[object Object]" !== Object.prototype.toString.call(o[r]) ? e[r] = o[r] : e[r] = cn(e[r], o[r]))
        }
        return e
    }
    ...
    function Sn(e, t) {
        e = i(e) ? e[0] : e;
        for (var n = null != t ? sn(t, e.parentNode) : e.parentNode.childNodes, o = 0, r = 0; r < n.length; r++) {
            if (n[r] == e) return o;
            1 == n[r].nodeType && o++
        }
        return -1
    ...
    function Tn(e) {
        for (var t = xt.createDocumentFragment(); e.firstChild;) t.appendChild(e.firstChild);
    ...
    return Lt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) { t = t || Lt; for (var n = 0; n < this.length; n++) e.call(t, this[n], n, this) }), Lt.fp_utils = { $: sn, deepExtend: cn, hasClass: un, getWindowHeight: fn, css: dn, until: n, prevUntil: vn, nextUntil: pn, prev: hn, next: gn, last: mn, index: Sn, getList: l, hide: bn, show: wn, isArrayOrList: i, addClass: yn, removeClass: En, appendTo: Ln, wrap: o, wrapAll: xn, wrapInner: An, unwrap: Tn, closest: kn, after: Mn, before: On, insertBefore: r, getScrollTop: Cn, siblings: Hn, preventDefault: In, isFunction: Bn, trigger: Rn, matches: zn, toggle: jn, createElementFromHTML: Nn, remove: Pn, filter: function(e, t) { Array.prototype.filter.call(e, t) }, untilAll: a, nextAll: Dn, prevAll: Vn, showError: an },
        function(e, E) {
            ...
            if (!un(sn("html"), Ct)) {
                ...
                v.k = cn({}, v.m);
                var p, s, m, S, k, M, b, w = Lt.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" },
                    ...
                    C = !1;
                try {
                    var H = Object.defineProperty({}, "passive", { get: function() { C = !0 } });
                    Lt.addEventListener("testPassive", null, H), Lt.removeEventListener("testPassive", null, H)
                } catch (e) {}
                var I, B = cn({}, E),
                    R = !1,
                    z = !0;
                mt(), Lt.fp_easings = cn(Lt.fp_easings, { easeInOutCubic: function(e, t, n, o) { return (e /= o / 2) < 1 ? n / 2 * e * e * e + t : n / 2 * ((e -= 2) * e * e + 2) + t } }), f && (h.version = "3.0.5", h.setAutoScrolling = _, h.setRecordHistory = K, h.setScrollingSpeed = $, h.setFitToSection = q, h.setLockAnchors = function(e) { E.lockAnchors = e }, h.setMouseWheelScrolling = Q, h.setAllowScrolling = G, h.setKeyboardScrolling = Z, h.moveSectionUp = ee, h.moveSectionDown = te, h.silentMoveTo = ne, h.moveTo = oe, h.moveSlideRight = re, h.moveSlideLeft = ie, h.fitToSection = he, h.reBuild = le, h.setResponsive = ae, h.getFullpageData = function() { return E }, h.destroy = function(e) {
                    _(!1, "internal"), G(!0), J(!1), Z(!1), yn(f, Ot), clearTimeout(S), clearTimeout(m), clearTimeout(s), clearTimeout(k), clearTimeout(M), Lt.removeEventListener("scroll", pe), Lt.removeEventListener("hashchange", Pe), Lt.removeEventListener("resize", qe), xt.removeEventListener("keydown", Ve), xt.removeEventListener("keyup", We), ["click", "touchstart"].forEach(function(e) { xt.removeEventListener(e, se) }), ["mouseenter", "touchstart", "mouseleave", "touchend"].forEach(function(e) { xt.removeEventListener(e, ue, !0) }), clearTimeout(S), clearTimeout(m), e && (vt(0), sn("img[data-src], source[data-src], audio[data-src], iframe[data-src]", f).forEach(function(e) { He(e, "src") }), sn("img[data-srcset]").forEach(function(e) { He(e, "srcset") }), Pn(sn(Ft + ", " + en + ", " + nn)), dn(sn(jt), { height: "", "background-color": "", padding: "" }), dn(sn(_t), { width: "" }), dn(f, { height: "", position: "", "-ms-touch-action": "", "touch-action": "" }), dn(r, { overflow: "", height: "" }), En(sn("html"), Ct), En(L, kt), L.className.split(/\s+/).forEach(function(e) { 0 === e.indexOf(Ht) && En(L, e) }), sn(jt + ", " + _t).forEach(function(e) {
                        E.scrollOverflowHandler && E.scrollOverflow && E.scrollOverflowHandler.remove(e), En(e, Jt + " " + It + " " + Rt);
                        var t = e.getAttribute("data-fp-styles");
                        t && e.setAttribute("style", e.getAttribute("data-fp-styles")), un(e, zt) && !R && e.removeAttribute("data-anchor")
                    }), Je(f), [Dt, Gt, qt].forEach(function(e) { sn(e, f).forEach(function(e) { Tn(e) }) }), dn(f, { "-webkit-transition": "none", transition: "none" }), Lt.scrollTo(0, 0), [zt, Xt, Qt].forEach(function(e) { En(sn("." + e), e) }))
                }, h.getActiveSection = function() { return new yt(sn(Nt)[0]) }, h.getActiveSlide = function() { return Me(sn(Kt, sn(Nt)[0])[0]) }, h.test = { top: "0px", translate3d: "translate3d(0px, 0px, 0px)", translate3dH: function() { for (var e = [], t = 0; t < sn(E.sectionSelector, f).length; t++) e.push("translate3d(0px, 0px, 0px)"); return e }(), left: function() { for (var e = [], t = 0; t < sn(E.sectionSelector, f).length; t++) e.push(0); return e }(), options: E, setAutoScrolling: _ }, h.shared = { afterRenderActions: ve }, Lt.fullpage_api = h, E.$ && (E.$.fn.fullpage = h), E.css3 && (E.css3 = function() {
                    var e, t = xt.createElement("p"),
                    ...
                    for (var o in t.style.display = "block", xt.body.insertBefore(t, null), n) void 0 !== t.style[o] && (t.style[o] = "translate3d(1px,1px,1px)", e = Lt.getComputedStyle(t).getPropertyValue(n[o]));
                    return xt.body.removeChild(t), void 0 !== e && 0 < e.length && "none" !== e
                }()), E.scrollBar = E.scrollBar || E.hybrid, function() {
                    if (!E.anchors.length) {
                        var e = "[data-anchor]",
                            t = sn(E.sectionSelector.split(",").join(e + ",") + e, f);
                        t.length && (R = !0, t.forEach(function(e) { E.anchors.push(e.getAttribute("data-anchor").toString()) }))
                    }
                    if (!E.navigationTooltips.length) {
                        var e = "[data-tooltip]",
                            n = sn(E.sectionSelector.split(",").join(e + ",") + e, f);
                        n.length && n.forEach(function(e) { E.navigationTooltips.push(e.getAttribute("data-tooltip").toString()) })
                    }
                }(), function() {
                    dn(f, { height: "100%", position: "relative" }), yn(f, At), yn(sn("html"), Ct), A = fn(), En(f, Ot), yn(sn(E.sectionSelector, f), zt), yn(sn(E.slideSelector, f), Xt);
                    for (var e = sn(jt), t = 0; t < e.length; t++) {
                        var n = t,
                            o = e[t],
                            r = sn(_t, o),
                            i = r.length;
                        o.setAttribute("data-fp-styles", o.getAttribute("style")), s = o, (c = n) || null != sn(Nt)[0] || yn(s, It), u = sn(Nt)[0], dn(s, { height: A + "px" }), E.paddingTop && dn(s, { "padding-top": E.paddingTop }), E.paddingBottom && dn(s, { "padding-bottom": E.paddingBottom }), void 0 !== E.sectionsColor[c] && dn(s, { "background-color": E.sectionsColor[c] }), void 0 !== E.anchors[c] && s.setAttribute("data-anchor", E.anchors[c]), l = o, a = n, void 0 !== E.anchors[a] && un(l, It) && Ze(E.anchors[a], a), E.menu && E.css3 && null != kn(sn(E.menu)[0], Tt) && sn(E.menu).forEach(function(e) { L.appendChild(e) }), 0 < i ? fe(o, r, i) : E.verticalCentered && tt(o)
                    }
                    var l, a, s, c;
                    E.fixedElements && E.css3 && sn(E.fixedElements).forEach(function(e) { L.appendChild(e) }), E.navigation && function() {
                        var e = xt.createElement("div");
                        e.setAttribute("id", Yt);
                        var t = xt.createElement("ul");
                        e.appendChild(t), Ln(e, L);
                        var n = sn(Ft)[0];
                        yn(n, "fp-" + E.navigationPosition), E.showActiveTooltip && yn(n, "fp-show-active");
                        for (var o = "", r = 0; r < sn(jt).length; r++) {
                            var i = "";
                            E.anchors.length && (i = E.anchors[r]), o += '<li><a href="#' + i + '"><span class="fp-sr-only">' + de(r, "Section") + "</span><span></span></a>";
                            var l = E.navigationTooltips[r];
                            void 0 !== l && "" !== l && (o += '<div class="' + Ut + " fp-" + E.navigationPosition + '">' + l + "</div>"), o += "</li>"
                        }
                        sn("ul", n)[0].innerHTML = o, dn(sn(Ft), { "margin-top": "-" + sn(Ft)[0].offsetHeight / 2 + "px" }), yn(sn("a", sn("li", sn(Ft)[0])[Sn(sn(Nt)[0], jt)]), It)
                    }(), sn('iframe[src*="youtube.com/embed/"]', f).forEach(function(e) {
                        var t, n, o;
                        n = "enablejsapi=1", o = (t = e).getAttribute("src"), t.setAttribute("src", o + (/\?/.test(o) ? "&" : "?") + n)
                    }), E.scrollOverflow && (p = E.scrollOverflowHandler.init(E))
                }(), G(!0), J(!0), _(E.autoScrolling, "internal"), Qe(), ut(), "complete" === xt.readyState && Ne(), Lt.addEventListener("load", Ne), E.scrollOverflow || ve(), Lt.addEventListener("scroll", pe), Lt.addEventListener("hashchange", Pe), Lt.addEventListener("blur", Xe), Lt.addEventListener("resize", qe), xt.addEventListener("keydown", Ve), xt.addEventListener("keyup", We), ["click", "touchstart"].forEach(function(e) { xt.addEventListener(e, se) }), E.normalScrollElements && (["mouseenter", "touchstart"].forEach(function(e) { ce(e, !1) }), ["mouseleave", "touchend"].forEach(function(e) { ce(e, !0) })));
                var j = !1,
                    N = 0,
                    P = 0,
                    D = 0,
            ...
            function _(e, t) {
                e || vt(0), gt("autoScrolling", e, t);
                var n = sn(Nt)[0];
                if (E.autoScrolling && !E.scrollBar) dn(r, { overflow: "hidden", height: "100%" }), K(B.recordHistory, "internal"), dn(f, { "-ms-touch-action": "none", "touch-action": "none" }), null != n && vt(n.offsetTop);
                else if (dn(r, { overflow: "visible", height: "initial" }), K(!!E.autoScrolling && B.recordHistory, "internal"), dn(f, { "-ms-touch-action": "", "touch-action": "" }), null != n) {
                    var o = Oe(n.offsetTop);
            ...
            function Q(e) {
                e ? (function() {
                    ...
                    var n = "onwheel" in xt.createElement("div") ? "wheel" : void 0 !== xt.onmousewheel ? "mousewheel" : "DOMMouseScroll",
                        o = !!C && { passive: !1 };
                    "DOMMouseScroll" == n ? xt[e](t + "MozMousePixelScroll", Ee, o) : xt[e](t + n, Ee, o)
            ...
            function J(e) {
                e ? (Q(!0), function() {
                    if (o || l) {
                        E.autoScrolling && (L.removeEventListener(y.touchmove, me, { passive: !1 }), L.addEventListener(y.touchmove, me, { passive: !1 }));
                        var e = E.touchWrapper;
                        e.removeEventListener(y.touchstart, we), e.removeEventListener(y.touchmove, Se, { passive: !1 }), e.addEventListener(y.touchstart, we), e.addEventListener(y.touchmove, Se, { passive: !1 })
                    }
                }()) : (Q(!1), function() {
                    if (o || l) {
                        E.autoScrolling && (L.removeEventListener(y.touchmove, Se, { passive: !1 }), L.removeEventListener(y.touchmove, me, { passive: !1 }));
                        var e = E.touchWrapper;
            ...
            function le(e) {
                if (!un(f, Ot)) {
                    g = !0, A = fn();
                    for (var t = sn(jt), n = 0; n < t.length; ++n) {
                        var o = t[n],
                            r = sn(qt, o)[0],
                            i = sn(_t, o);
            ...
            function se(e) {
                var t = e.target;
                t && kn(t, Ft + " a") ? function(e) {
                    In(e);
                    var t = Sn(kn(this, Ft + " li"));
                    Ae(sn(jt)[t])
                }.call(t, e) : zn(t, ".fp-tooltip") ? function() { Rn(hn(this), "click") }.call(t) : zn(t, nn) ? function() {
                    var e = kn(this, jt);
                    un(this, on) ? v.m.left && ie(e) : v.m.right && re(e)
                }.call(t, e) : zn(t, tn) || null != kn(t, tn) ? function(e) {
                    In(e);
                    var t = sn(qt, kn(this, jt))[0],
                        n = sn(_t, t)[Sn(kn(this, "li"))];
                    Ke(t, n)
                }.call(t, e) : kn(t, E.menu + " [data-menuanchor]") && function(e) {!sn(E.menu)[0] || !E.lockAnchors && E.anchors.length || (In(e), oe(this.getAttribute("data-menuanchor"))) }.call(t, e)
            }
            ...
            function fe(e, t, n) {
                ...
                i.className = $t, xn(t, i);
                var l, a, s = xt.createElement("div");
                s.className = Qt, xn(t, s), dn(sn(Gt, e), { width: o + "%" }), 1 < n && (E.controlArrows && (l = e, a = [Nn('<div class="fp-controlArrow fp-prev"></div>'), Nn('<div class="fp-controlArrow fp-next"></div>')], Mn(sn(qt, l)[0], a), "#fff" !== E.controlArrowColor && (dn(sn(ln, l), { "border-color": "transparent transparent transparent " + E.controlArrowColor }), dn(sn(rn, l), { "border-color": "transparent " + E.controlArrowColor + " transparent transparent" })), E.loopHorizontal || bn(sn(rn, l))), E.slidesNavigation && function(e, t) {
                    Ln(Nn('<div class="' + Zt + '"><ul></ul></div>'), e);
                    var n = sn(en, e)[0];
                    yn(n, "fp-" + E.slidesNavPosition);
                    for (var o = 0; o < t; o++) Ln(Nn('<li><a href="#"><span class="fp-sr-only">' + de(o, "Slide") + "</span><span></span></a></li>"), sn("ul", n)[0]);
                    dn(n, { "margin-left": "-" + n.innerWidth / 2 + "px" }), yn(sn("a", sn("li", n)[0]), It)
                }(e, n)), t.forEach(function(e) { dn(e, { width: r + "%" }), E.verticalCentered && tt(e) });
                var c = sn(Kt, e)[0];
            ...
            function pe() {
                ...
                if (!E.autoScrolling || E.scrollBar) {
                    ...
                    if (t = a, n = sn(Nt)[0].offsetTop, o = n + fn(), ("up" != t ? n <= Cn() : o >= Cn() + fn()) && (un(sn(Nt)[0], Rt) || (yn(sn(Nt)[0], Rt), En(Hn(sn(Nt)[0]), Rt))), !un(e = f[s], It)) {
                        j = !0;
                        var v, p, h = sn(Nt)[0],
                            g = Sn(h, jt) + 1,
                            m = et(e),
            ...
            function ge(e) {
                if (v.m[e]) {
                    var t = "down" === e ? te : ee;
                    if (E.scrollOverflow) {
                        var n = E.scrollOverflowHandler.scrollable(sn(Nt)[0]),
                            o = "down" === e ? "bottom" : "top";
                        if (null != n) {
            ...
            function Se(e) {
                var t = kn(e.target, jt) || sn(Nt)[0];
                if (be(e)) {
                    E.autoScrolling && In(e);
                    var n = ft(e);
            ...
            function Ee(e) {
                var t = (new Date).getTime(),
                    n = un(sn(".fp-completely")[0], Wt);
                if (!v.m.down && !v.m.up) return In(e), !1;
                if (E.autoScrolling && !c && !n) {
                    var o = (e = e || Lt.event).wheelDelta || -e.deltaY || -e.detail,
                    ...
                    149 < d.length && d.shift(), d.push(Math.abs(o)), E.scrollBar && In(e);
                    var a = t - Y;
                    if (Y = t, 200 < a && (d = []), T) {
                        var s = ye(d, 10);
                        ye(d, 70) <= s && l && ge(r < 0 ? "down" : "up")
                    }
                    return !1
                }
                E.fitToSection && (I = !1)
            ...
            function Le(e, t) {
                var n = null == t ? sn(Nt)[0] : t,
                    o = sn(qt, n)[0];
                if (!(null == o || a || sn(_t, o).length < 2)) {
                    var r = sn(Kt, o)[0],
                        i = null;
                    if (null == (i = "left" === e ? vn(r, _t) : pn(r, _t))) {
            ...
            function Ae(e, t, n) {
                if (null != e) {
                    ...
                    if (!(d.activeSection == e && !g || E.scrollBar && Cn() === d.dtop && !un(e, Vt))) {
                        if (null != d.activeSlide && (u = d.activeSlide.getAttribute("data-anchor"), f = Sn(d.activeSlide)), !d.localIsResizing) { var v = d.yMovement; if (void 0 !== n && (v = n ? "up" : "down"), d.direction = v, Bn(E.onLeave) && !1 === Te("onLeave", d)) return }
                        E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? On(sn(Nt)[0], Dn(p.activeSection, jt)) : Mn(sn(Nt)[0], Vn(p.activeSection, jt).reverse()), vt(sn(Nt)[0].offsetTop), xe(), p.wrapAroundElements = p.activeSection, p.dtop = p.element.offsetTop, p.yMovement = et(p.element), p.leavingSection = Sn(p.activeSection, jt) + 1, p.sectionIndex = Sn(p.element, jt), d = p), d.localIsResizing || ze(d.activeSection), E.scrollOverflow && E.scrollOverflowHandler.beforeLeave(), yn(e, It), En(Hn(e), It), Ie(e), E.scrollOverflow && E.scrollOverflowHandler.onLeave(), T = h.test.isTesting, at(f, u, d.anchorLink, d.sectionIndex),
                            function(e) {
                                if (E.css3 && E.autoScrolling && !E.scrollBar) {
                                    ...
                                    ot(t, !0), E.scrollingSpeed ? (clearTimeout(m), m = setTimeout(function() { Ce(e) }, E.scrollingSpeed)) : Ce(e)
                                } else {
                                    var n = Oe(e.dtop);
                                    h.test.top = -e.dtop + "px", St(n.element, n.options, E.scrollingSpeed, function() { E.scrollBar ? setTimeout(function() { Ce(e) }, 30) : Ce(e) })
                                }
                            }(d), x = d.anchorLink, Ze(d.anchorLink, d.sectionIndex)
                    }
                }
                var p
            }
            ...
            function Ie(e) {
                E.lazyLoading && sn("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", je(e)).forEach(function(n) {
            ...
            function Ve(e) {
                ...
                9 === n ? function(e) {
                    ...
                    function f(e) { return In(e), u[0] ? u[0].focus() : null }(t = e, n = Ue(xt), o = n.indexOf(xt.activeElement), r = t.shiftKey ? o - 1 : o + 1, i = n[r], l = Me(kn(i, _t)), a = ke(kn(i, jt)), l || a) && (c ? null == kn(c, Nt + "," + Nt + " " + Kt) && (c = f(e)) : f(e), (!s && c == u[u.length - 1] || s && c == u[0]) && In(e))
                }(e) : zn(t, "textarea") || zn(t, "input") || zn(t, "select") || "true" === t.getAttribute("contentEditable") || "" === t.getAttribute("contentEditable") || !E.keyboardScrolling || !E.autoScrolling || (-1 < [40, 38, 32, 33, 34].indexOf(n) && In(e), c = e.ctrlKey, b = setTimeout(function() {
                    ! function(e) {
                        var t = e.shiftKey;
            ...
            function Ke(e, t, n) {
                ...
                l.xMovement = (o = l.prevSlideIndex, r = l.slideIndex, o == r ? "none" : r < o ? "left" : "right"), l.direction = l.direction ? l.direction : l.xMovement, l.localIsResizing || (T = !1), E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && Bn(E.onSlideLeave) && !1 === Te("onSlideLeave", l) ? a = !1 : (yn(t, It), En(Hn(t), It), l.localIsResizing || (ze(l.prevSlide), Ie(t)), !E.loopHorizontal && E.controlArrows && (jn(sn(rn, i), 0 !== l.slideIndex), jn(sn(ln, i), null != gn(t))), un(i, It) && !l.localIsResizing && at(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex), function(e, t, n) {
                    ...
                    if (E.css3) {
                        ...
                        h.test.translate3dH[t.sectionIndex] = r, dn(Ge(sn(Gt, e)), pt(r)), S = setTimeout(function() { n && $e(t) }, E.scrollingSpeed)
                    } else h.test.left[t.sectionIndex] = Math.round(o.left), St(e, Math.round(o.left), E.scrollingSpeed, function() { n && $e(t) })
                }(e, l, !0))
            }
            ...
            function qe() {
                if (Qe(), o) {
                    var e = xt.activeElement;
                    if (!zn(e, "textarea") && !zn(e, "input") && !zn(e, "select")) {
                        var t = fn();
                        Math.abs(t - X) > 20 * Math.max(X, t) / 100 && (s = setTimeout(function() { le(!0), X = t }, navigator.userAgent.match("CriOS") ? 50 : 0))
                    }
                } else clearTimeout(s), s = setTimeout(function() { le(!0) }, 350)
            }
            ...
            function it(e, t) {
                var n = rt(e);
                if (null != n) {
                    var o, r, i, l = (null == (i = sn(_t + '[data-anchor="' + (o = t) + '"]', r = n)[0]) && (o = void 0 !== o ? o : 0, i = sn(_t, r)[o]), i);
            ...
            function st(e) {
                if (E.recordHistory) location.hash = e;
                    ...
                    var t = Lt.location.href.split("#")[0];
            ...
            function vt(e) {
                var t = Math.round(e);
                if (E.css3 && E.autoScrolling && !E.scrollBar) ot("translate3d(0px, -" + t + "px, 0px)", !1);
            ...
            function mt() {
                ...
                n ? e && e.length < 20 && (console.warn("%c This website was made using fullPage.js slider. More info on the following website:", t), console.warn("%c https://alvarotrigo.com/fullPage/", t)) : (an("error", "Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:"), an("error", "https://github.com/alvarotrigo/fullPage.js#options.")), un(sn("html"), Ct) ? an("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (E.continuousVertical && (E.loopTop || E.loopBottom) && (E.continuousVertical = !1, an("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !E.scrollOverflow || !E.scrollBar && E.autoScrolling || an("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !E.continuousVertical || !E.scrollBar && E.autoScrolling || (E.continuousVertical = !1, an("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), E.scrollOverflow && null == E.scrollOverflowHandler && (E.scrollOverflow = !1, an("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")), ["fadingEffect", "continuousHorizontal", "scrollHorizontally", "interlockedSlides", "resetSliders", "responsiveSlides", "offsetSections", "dragAndMove", "scrollOverflowReset", "parallax", "cards"].forEach(function(e) { E[e] && an("warn", "fullpage.js extensions require fullpage.extensions.min.js file instead of the usual fullpage.js. Requested: " + e) }), E.anchors.forEach(function(t) {
                    var e = [].slice.call(sn("[name]")).filter(function(e) { return e.getAttribute("name") && e.getAttribute("name").toLowerCase() == t.toLowerCase() }),
            ...
            function St(t, n, o, r) {
                var e, i = (e = t).self != Lt && un(e, $t) ? e.scrollLeft : !E.autoScrolling || E.scrollBar ? Cn() : e.offsetTop,
                    l = n - i,
                    a = 0;
                I = !0;
                var s = function() {
                    if (I) {
                        var e = n;
                        a += 20, o && (e = Lt.fp_easings[E.easing](a, i, l, o)), bt(t, e), a < o ? setTimeout(s, 20) : void 0 !== r && r()
                    } else a < o && r()
                };
                s()
            }
    ...
    "use strict";
    t && n ? t.fn.fullpage = function(e) { e.$ = t, new n(this[0], e) } : window.fp_utils.showError("error", "jQuery is required to use the jQuery fullpage adapter!")
